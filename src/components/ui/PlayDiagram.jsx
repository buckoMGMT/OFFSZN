...
export default function PlayDiagram({ size = 180, className = "" }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 180 180" fill="none" className={className}>
      ...
      {[50, 90, 130].map((cx, i) => (
        <g key={i}>
          <line x1={cx-6} y1={134} x2={cx+6} y2={146} stroke="#00C853" strokeWidth="2" />
          <line x1={cx+6} y1={134} x2={cx-6} y2={146} stroke="#00C853" strokeWidth="2" />
        </g>
      ))}
      ...
      {drawn && <>
        {/* Curl route left */}
        <path d="M38 102 L38 68 Q38 52 54 52 Q68 52 68 66" stroke="#00C853" strokeWidth="1.5" fill="none"
        ...
        {/* Fly route right */}
        <path d="M142 102 L142 46" stroke="#00C853" strokeWidth="1.5" fill="none"
          strokeDasharray="200" strokeLinecap="round"
        ...
        {/* Crossing route */}
        <path d="M62 102 L62 74 L118 74" stroke="#00C853" strokeWidth="1.5" fill="none"
          strokeDasharray="200" strokeLinecap="round"
