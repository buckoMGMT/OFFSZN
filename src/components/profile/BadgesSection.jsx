...
const BADGES = [
  ...
  { id: "premium", icon: Star, label: "Premium Playbook", desc: "Premium member", color: "text-primary", bg: "bg-primary/15", border: "border-primary/30", check: (a) => a.subscription_tier === "premium" },
  ...
  { id: "profile_complete", icon: Star, label: "Full Playbook", desc: "Complete profile", color: "text-primary", bg: "bg-primary/10", border: "border-primary/20", check: (a) => !!(a.sport && a.school && a.position && a.bio) },
];
